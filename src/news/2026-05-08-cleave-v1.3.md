...
[cleave](/cleave/) v1.3: two big things, a pile of small ones.
...
Each scope emits a rate-of-change score in `[0, 1]`, weighted by criticality and confidence. A point release that looks like a rewrite is worth knowing. This is the signal feeding our forthcoming differential analyzer for ranking releases by supply-chain risk.
...
[v1.3.1 release notes](https://github.com/atomdrift-project/cleave/releases/tag/v1.3.1) · [FILE_FORMATS.md](https://github.com/atomdrift-project/cleave/src/branch/main/FILE_FORMATS.md)

```
brew upgrade atomdrift-project/tap/cleave
```
